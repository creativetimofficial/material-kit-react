...
- Bugs from updated dependencies and Node 18 support
...
```
@emotion/cache                             11.4.0   →   11.10.5
@emotion/react                             11.4.1   →   11.10.5
@emotion/styled                            11.3.0   →   11.10.5
@mui/icons-material                         5.2.0   →    5.11.0
@mui/material                               5.2.0   →    5.11.8
@mui/styled-engine                          5.2.0   →    5.11.8
...
react-countup                               6.1.0   →     6.4.1
react-dom                                  17.0.2   →    18.2.0
react-flatpickr                            3.10.7   →   3.10.13
react-router-dom                            6.0.2   →     6.8.1
react-scripts                               4.0.3   →     5.0.1
react-syntax-highlighter                   15.4.5   →    15.5.0
web-vitals                                  1.0.1   →     3.1.1
eslint:                                    7.30.0   →    8.34.0
