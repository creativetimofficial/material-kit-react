...
export const team = [
  {
    ...
    role: 'Model',
    description:
      'You can write here details about one of your team members. You can give more details about what they do. Feel free to add some <a href="#">links</a> for people to be able to follow them outside the site.',
    links: {
      twitter: '#twitter',
      instagram: '#instagram',
      facebook: '#facebook'
